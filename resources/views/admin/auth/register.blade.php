    ...
    @push('styles')
        <style>
            ...
            .hero-card {
                ...
                border-radius: 40px;
                padding: 80px 60px;
                /* Padding diperbesar agar lebih lega seperti di gambar */
                min-height: 550px;
                display: flex;
                flex-direction: column;
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="hero-card">
                        ...
                        <img src="{{ asset('assets/images/hero-cms.svg') }}" alt="CMS Illustration"
                            class="mx-auto d-block mt-4" style="width: 100%; max-width: 400px;">
                    </div>
                </div>
                ...
                <div class="col-lg-5 offset-lg-1 d-flex flex-column justify-content-center">
                    <div class="login-form-section">
                        ...
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted">
                                Join thousands of users and make landing page in minutes.
                            </p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                <label class="form-label small fw-bold">Username <span
                                        class="text-danger">*</span></label>
                                <input type="username" class="form-control" id="username" name="username" placeholder="Choose a unique username" required
                                    autofocus>
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="email" class="form-control" name="email" placeholder="e.g., alex@company.com"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label small fw-bold">
                            ...
                            <div class="text-center">
                                <span class="small text-muted">
                                    ...
                                    <a href="{{ route('login') }}" class="text-primary text-decoration-none fw-bold ms-1">
                                        Log In
                                    </a>
                                </span>
                            </div>
